...
const Section = ({ className, id, crosses, crossesOffset, customPaddings, children, hero }) => {
  return (
    <div
      id={id}
      className={`
      relative
      ${hero ? "bg-background-img-hero" : ""}
      ...
      {crosses && (
        <>
          <div
            className={`hidden absolute top-0 left-7.5 right-7.5 h-0.25 bg-stroke-1/20 ${
